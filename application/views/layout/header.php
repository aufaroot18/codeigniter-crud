        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url(); ?>student/create"><i class="fa fa-circle-o"></i> Tambah Mahasiswa</a></li>
              <li><a href="<?= base_url(); ?>student"><i class="fa fa-circle-o"></i> List Mahasiswa</a></li>
            </ul>
          </li>
